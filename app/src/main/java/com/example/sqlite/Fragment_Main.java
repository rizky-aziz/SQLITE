 ...
 */
public class Fragment_Main extends Fragment implements View.OnClickListener,RecyclerViewAdapter.OnUserClickListener{
    ...
    @Override
    public void OnUserClick(PersonBean currentPeron, String action) {
        if (action.equals("Edit")) {
            edtName.setText(currentPeron.getName());
            edtName.setFocusable(false);
            edtAge.setText(currentPeron.getAge()+"");
            btnSubmit.setText("Update");
        }
        if (action.equals("Delete")) {
            DatabaseHelper db = new DatabaseHelper(context);
            db.delete(currentPeron.getName());
            setupRecyclerView();
        }
    }
}
